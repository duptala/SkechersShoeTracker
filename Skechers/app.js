...
async function populateSectionsWithShoes() {
  ...
  const response = await fetch(`https://skechersshoetracker.onrender.com/shoes/getallshoes`);
...
async function insertShoeIntoSection(stock, section_name) {
  await fetch(`https://skechersshoetracker.onrender.com/shoes/insert/${stock}/${section_name}`);
}

async function updateShoeIntoSection(stock, section_name) {
  await fetch(`https://skechersshoetracker.onrender.com/shoes/update/${stock}/${section_name}`);
}

async function deleteShoesIntoSection(section_name) {
  await fetch(`https://skechersshoetracker.onrender.com/shoes/delete/${section_name}`);
}
